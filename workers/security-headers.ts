...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    const securityHeaders = {
      ...
      'Content-Security-Policy': [
        "default-src 'self'",
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://em.realscout.com https://www.realscout.com https://widgetbe.com https://assets.calendly.com https://www.googletagmanager.com https://www.google-analytics.com",
